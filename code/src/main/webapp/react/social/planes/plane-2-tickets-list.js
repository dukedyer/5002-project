...
const findAllPlanes2 = (id) => fetch(`${"http://localhost:8080/api/plane2tickets"}/${id}`)
...
const Plane2TicketList = () => {
    ...
    return(
        <div>
            {isStuff(planes) && <h2>Tickets With Plane {id}</h2>}
...
export default Plane2TicketList;